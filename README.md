...
> **설치된 버전 확인**: 앱 안 **개발자 탭 → 설치된 빌드**에 실제 버전이 표시됩니다.
> 릴리스 제목의 빌드 번호와 같으면 최신입니다.
>
...
앱을 처음 열면 **설정 안내 화면**이 먼저 나옵니다. 두 가지만 켜주면 끝이고, 각 항목을 누르면 해당 시스템 화면으로 바로 이동합니다.
...
4. 그래도 안 되면 **개발자 모드 탭 → 진단 리포트**를 확인하거나 [이슈](https://github.com/lsk0522/Apple_style_Clock/issues)로 알려주세요.
