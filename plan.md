...
- [ ] 삼성 절전 예외 · Daily Board 끄기 온보딩 → **Phase 3 으로 이월**
...
### Phase 3 — StandBy 화면 실행 · 5~6일 · 핵심 ①

- [ ] `ChargingMonitorService` (포그라운드, specialUse) — Phase 2 에서 이월
- [ ] 오버레이 권한 온보딩 (거부해도 진행 가능)
- [ ] 삼성 절전 예외 · One UI Daily Board 끄기 안내 — Phase 2 에서 이월
